...
<head>
    ...
    height: 75px; 
		...
		html { 
		  background : url(img/background9jpg.jpg) no-repeat center center fixed; 
...
<div id="logo">
	<A HREF="index.php">
<IMG SRC="img/logo2.png" alt="Home" id="logo" width="100" height="100" align="left"></IMG>
</A></div><div id="main">
<center>
	...
	<?php  
		if(isset($_SESSION['user_info'])){
			...
			echo '<A HREF="register.php"><input type="submit" class="button" value="Cancel your ticket!" name="cancel" id="cancel"/></A>';
		?>
	</form>
	</div>
</center>
